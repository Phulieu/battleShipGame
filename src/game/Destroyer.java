...
public class Destroyer extends Ship{
     ...
     * @param sName
     */
    public Destroyer(ShipType[] sPreferredTarget, String sName) {
        super((int) (Math.random()*25+50),100,25,15,sPreferredTarget);
        this.sName = sName;
    }
    @Override
    /**
...
//            if (this.nHitPoints < 0) this.nHitPoints =0;
        }
    ...
    public ShipType pickTarget(){
        ...
        if (randomPro <=10) return sPreferredTarget[0];
            //in range 70% next
        else if ( randomPro <=80 ) return sPreferredTarget[1];
            //in range 10% next
